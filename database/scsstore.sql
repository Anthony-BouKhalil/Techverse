...
(9, 'Dell XPS 15', 1000, '2499.99', 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/xps-notebooks/xps-15-9520/media-gallery/black/laptop-xps-9520-t-black-gallery-3.psd?fmt=png-alpha&pscan=auto&scl=1&hei=402&wid=653&qlt=100,1&resMode=sharp2&size=653,402&chrss=full', 'Dell XPS 15 is a Windows 10 Professional laptop with a 15.60-inch display that has a resolution of 1920x1080 pixels. The Dell XPS 15 packs 256GB of SSD storage. Graphics are powered by Nvidia GeForce GTX 1050 Ti.', 'Laptops'),
